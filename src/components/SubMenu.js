...
export default function SubMenu({name, activeMenu, iconName}) {
    return (
        <div onClick={activeMenu} className={`select-none rounded-lg flex items-end gap-4 cursor-pointer pl-6 py-4 hover:pl-9 transition-all duration-300 text-gray-600`}>
